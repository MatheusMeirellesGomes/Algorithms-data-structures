...
int main()
{
    ...
    //Receber código do cliente para verificar se ele é maior que zero.
    printf("Insira o codigo do cliente:\n");
    scanf("%d", &cod);

    //Executar enquanto o código for válido (> 0).
    while (cod > 0)
    {
        //Receber tipo de investimento e valor investido.
        ...
        //Acumular valor total investido.
        t_investido += valor;

        //Definir acréscimo conforme tipo de investimento.
        if (investimento == 1){
            acrescimo = 0.015;
        }
