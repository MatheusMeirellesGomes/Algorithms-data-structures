...
int main()
{
    ...
    //Acionar função. 
    float resultado = soma_inverso_fatorial(*ptrn); //Vai mandar o valor de N para a função e receber o resultado da soma. 

    //Imprimir resultado. 
    printf("S = %.2f\n", resultado);

    //Imprimir endereço e conteúdo do ponteiro N. 
    printf("\nEndereco de N: %p\n", ptrn); 
